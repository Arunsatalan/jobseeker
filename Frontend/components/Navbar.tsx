...
export default function Navbar({ savedJobsCount = 0, notificationCount = 0 }: NavbarProps) {
    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="py-2">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Interview prep & more</p>
                      </div>
                    </Link>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Jobs picked for you</p>
                      </div>
                    </Link>
        ...
        <div className="md:hidden flex items-center gap-2 py-2 border-t border-gray-100 text-sm">
          <Link href="/jobs" className="flex-1 px-3 py-1 rounded text-center text-gray-700 hover:bg-gray-100">
            Jobs
          </Link>
          <Link href="/saved" className="flex-1 px-3 py-1 rounded text-center text-gray-700 hover:bg-gray-100">
            Schedule
          </Link>
          <Link href="/applications" className="flex-1 px-3 py-1 rounded text-center text-gray-700 hover:bg-gray-100">
            Apps
          </Link>
        </div>
      </div>
